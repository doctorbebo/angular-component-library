export const withAllVariants = (): any => ({
    template: `
    <div style="padding: 24px; padding-top: 150px;">
    ...
    `,
    props: {
        getFontSize: (el: Element): string => window.getComputedStyle(el).fontSize,
        getFontWeight: (el: Element): string => window.getComputedStyle(el).fontWeight,
    },
});
